...
Class SimpleWYMeditor {
	...
	function addFilesWYMeditor() {
		...
		?>
		<script type="text/javascript" src="<?php echo $this->wymeditor_url;?>jquery.wymeditor.pack.js"></script>
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $this->wymeditor_url;?>skins/default/screen.css" />
		<style type="text/css">
	...
	function loadWYMeditor() {
		...
		$selector = '.mceEditor';
		if( $this->wp_25 === true || $this->wp_26 === true ) {
			$selector = '#editorcontainer textarea';
		}
		?>
		<script type="text/javascript">
			<!--
			jQuery( function() {
				jQuery('<?php echo $selector; ?>').wymeditor({
					...
					updateSelector: '.submit input',
					updateEvent: 'click',
					stylesheet: '<?php echo $this->plugin_url.'styles.css'; ?>'
